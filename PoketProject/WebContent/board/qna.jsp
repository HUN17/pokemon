...
<body>
     ...
     <table  class="table" style="width: 70%" > 
         <tr align="center">
            <td>
               <form method="post" action="main.jsp?mode=20" id="ff" class="form-inline">      
               	<a href="main.jsp?mode=22">
               ...
               <input type="button" value="찾기" id="findBtn" class="btn btn-primary" >
           		...
           		<div class="form-group" style="">
	               	<ul class="pagination">
					<li class="pagination"><a href="main.jsp?mode=4&page=<%=curpage>1?curpage-1:curpage%>"><
					</a></li>
				...
				%>
					<li class="pagination"><a href="main.jsp?mode=4&page=<%=curpage<totalpage?curpage+1:curpage%>">
					></a></li>
					</ul>
				</div>
