							...
							<div class="md-form" align="left">
								...
								<!-- 성별체크 -->
								  <label class="checkbox-inline" style="margin-left: 50px; font-size: 16px">						  
  									<input type="checkbox" id="inlineCheckbox1" name="gender" value="option1" checked="checked">
  									남자
									</label>
									<label class="checkbox-inline" style="font-size: 16px;">
									  <input type="checkbox" id="inlineCheckbox2" name="gender" value="option2" >
									  여자
									</label>
								...
								<!-- email -->
								<div class="md-form" align="left">
									 <input type="text" name="email" class="form-control" placeholder="Your Email" style="width: 30%; margin-left: 50px;">@
									 <input type="text" name="email1" id="site" class="form-control" placeholder="Email" style="width: 30%">
									<select id="combo"  style="height: 50px; margin: 10px;">
										<option>직접입력</option>
