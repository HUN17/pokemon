...
<body id="body">
	<center>
		<!-- outer div -->
			<div id="header" style="display:table-cell; vertical-align:middle; width:2000px; height:200px; /* background-color: #DAD9FF; */ margin:5px;">
					<h1>제휴 사이트 정보</h1>
					<h5>회원님께 유용한 사이트들을 모았습니다.</h5>
			</div>
			<div style="width:100%; height:1300px; /* background-color: #F6F6F6; */">
			<hr width="1000">
			<div class="section" style="width:1000px; height:300px; /* background-color:#FFD9EC; */ margin:0px;">
				<div class="img" style="width:270px; height:270px; float:left; /* background-color: #FAF4C0; */ margin:15px;">
					<a href="http://pokemonkorea.co.kr/main_v2" target="_blank">
						<img alt="포켓몬 코리아" src="../alliance/image/pokemonKor.png" width="270">
					</a>
				</div>
				<div class="text" style=" text-align: left; width:670px; height:270px; float:left; /* background-color: #CEFBC9; */ margin:15px;">
					<a href="http://pokemonkorea.co.kr/main_v2" target="_blank">
			...
			<hr width="1000">
			<div class="section" style="width:1000px; height:300px; /* background-color:#FFD9EC; */ margin:5px;">
