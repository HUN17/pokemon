...
<body>
		<div style="width: 1260px; height: 170px;">
			...
			<div class="icon">
				...
				<a href="#">
					<img alt="SIST 녀석들" src="../alliance/image/icon_sistguys.png" onmouseover="this.src='../alliance/image/icon_sistguys_h.png';" onmouseout="this.src='../alliance/image/icon_sistguys.png';"width="100">
